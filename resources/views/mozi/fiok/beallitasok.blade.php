<div class="tab-pane fade" id="beallitasok" role="tabpanel" aria-labelledby="beallitasok-line-tab" wire:ignore.self>
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            <!--begin::Form-->
            <form id="kt_account_profile_details_form" class="form" wire:submit.prevent="mentes" enctype="multipart/form-data">
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <!--begin::Label-->
                        <label for="profilkep" class="col-lg-4 col-form-label fw-semibold fs-6">Profilkép</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <!--begin::Image input-->
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ asset('storage/' . $user->profilkep) }}')">
                                <!--begin::Preview existing avatar-->
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('storage/' . $user->profilkep) }}')"></div>
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                    ...
                                    <!--begin::Inputs-->
                                    <input type="file" wire:model="profilkep" for="profilkep" name="avatar" accept=".png, .jpg, .jpeg" />
                            ...
                            <!--end::Image input-->
                            <!--begin::Hint-->
                            <div class="form-text">Elfogadott képtipusok: png, jpg, jpeg.</div>
                            <!--end::Hint-->
                        </div>
                        <!--end::Col-->
                    </div>
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Mentés változtatása</button>
                </div>
                <!--end::Actions-->
            </form>
            <!--end::Form-->
