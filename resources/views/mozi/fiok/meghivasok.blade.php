<div class="tab-pane fade" id="meghivasok" role="tabpanel" aria-labelledby="meghivasok-line-tab" wire:ignore.self>
    <div class="card mb-5 mb-xl-10" bis_skin_checked="1">
        <!--begin::Body-->
        <div class="card-body py-10" bis_skin_checked="1">
            <h2 class="mb-9">Referral Program</h2>
            <!--begin::Overview-->
            <div class="row mb-10" bis_skin_checked="1">
                <!--begin::Col-->
                <div class="col-xl-6 mb-15 mb-xl-0 pe-5" bis_skin_checked="1">
            ...
            <div class="row" bis_skin_checked="1">
                ...
                <div class="col" bis_skin_checked="1">
                    <div class="card card-dashed flex-center min-w-175px my-3 p-6" bis_skin_checked="1">
                        ...
                        <span data-kt-countup="true" data-kt-countup-value="63,240.00" class="counted" data-kt-initialized="1">63,240</span></span>
                    </div>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col" bis_skin_checked="1">
                    <div class="card card-dashed flex-center min-w-175px my-3 p-6" bis_skin_checked="1">
                        ...
                        <span class="fs-lg-2tx fw-bold d-flex justify-content-center">$
                        <span data-kt-countup="true" data-kt-countup-value="8,530.00" class="counted" data-kt-initialized="1">8,530</span></span>
                    </div>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col" bis_skin_checked="1">
                    <div class="card card-dashed flex-center min-w-175px my-3 p-6" bis_skin_checked="1">
                        ...
                        <span class="fs-lg-2tx fw-bold d-flex justify-content-center">$
                        <span data-kt-countup="true" data-kt-countup-value="2,600" class="counted" data-kt-initialized="1">2,600</span></span>
                    </div>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col" bis_skin_checked="1">
                    <div class="card card-dashed flex-center min-w-175px my-3 p-6" bis_skin_checked="1">
                        ...
                        <span class="fs-lg-2tx fw-bold d-flex justify-content-center">$
                        <span data-kt-countup="true" data-kt-countup-value="783&quot;" class="counted" data-kt-initialized="1">783</span></span>
                    </div>
                </div>
                <!--end::Col-->
            </div>
            ...
            <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6" bis_skin_checked="1">
                ...
                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap" bis_skin_checked="1">
                    ...
                    <div class="mb-3 mb-md-0 fw-semibold" bis_skin_checked="1">
                        ...
                        <div class="fs-6 text-gray-700 pe-7" bis_skin_checked="1">Withdraw money securily to your bank account. Commision is $25 per transaction under $50,000</div>
                    </div>
                    <!--end::Content-->
                    <!--begin::Action-->
    ...
    <div class="card" bis_skin_checked="1">
            ...
            <div class="card-toolbar" bis_skin_checked="1">
                ...
                <ul class="nav nav-stretch fs-5 fw-semibold nav-line-tabs border-transparent" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a id="kt_referrals_tab_1" class="nav-link text-active-gray-800 me-4 active" data-bs-toggle="tab" role="tab" href="#kt_referrals_1" aria-selected="true">Month</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a id="kt_referrals_tab_2" class="nav-link text-active-gray-800 me-4" data-bs-toggle="tab" role="tab" href="#kt_referrals_2" aria-selected="false" tabindex="-1">2022</a>
                    </li>
                    <li class="nav-item" role="presentation">
        ...
        <div id="kt_referred_users_tab_content" class="tab-content" bis_skin_checked="1">
            <!--begin::Tab panel-->
            <div id="kt_referrals_1" class="card-body p-0 tab-pane fade show active" role="tabpanel" aria-labelledby="kt_referrals_tab_1" bis_skin_checked="1">
            ...
            <!--end::Tab panel-->
            <!--begin::Tab panel-->
            <div id="kt_referrals_2" class="card-body p-0 tab-pane fade" role="tabpanel" aria-labelledby="kt_referrals_tab_2" bis_skin_checked="1">
                <div class="table-responsive" bis_skin_checked="1">
                    <!--begin::Table-->
                    <table class="table table-row-bordered align-middle gy-6">
                        <!--begin::Thead-->
            ...
            <!--end::Tab panel-->
            <!--begin::Tab panel-->
            <div id="kt_referrals_3" class="card-body p-0 tab-pane fade" role="tabpanel" aria-labelledby="kt_referrals_tab_3" bis_skin_checked="1">
                <div class="table-responsive" bis_skin_checked="1">
                    <!--begin::Table-->
                    <table class="table table-row-bordered align-middle gy-6">
                        <!--begin::Thead-->
