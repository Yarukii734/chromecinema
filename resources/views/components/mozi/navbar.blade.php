                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    @endif
                        ...
                        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" title="Itt tudod a felhasználókat kezelni." href="{{ route('mozi.admin.felhasznalokezeles') }}"  data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" title="Itt tudod a snackeket feltölteni." href="{{ route('mozi.admin.snackfeltoltes') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon">
                                        <i class="ki-duotone ki-code fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" title="Itt tudod a snackeket szerkeszteni." href="{{ route('mozi.admin.snackszerkesztes') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon">
                                        <i class="ki-duotone ki-code fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" title="Itt tudod a felhívásokat feltölteni." href="{{ route('mozi.admin.felhivasfeltoltes') }}" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                    <span class="menu-icon">
                                        <i class="ki-duotone ki-code fs-2">
                                            <span class="path1"></span>
                                            <span class="path2"></span>
