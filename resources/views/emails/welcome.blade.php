...
<head>
    ...
    <title>Üdvözlünk, {{ $user->keresztnev }}!</title>
    <!-- Google Fonts import -->
...
<body style="background-color: #f3f4f6; padding: 20px; font-family: 'Poppins', Arial, sans-serif;">
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div class="bg-gradient" style="padding: 32px; text-align: center;">
            <h1 style="font-size: 28px; font-weight: 600; color: white; margin-bottom: 16px;">Üdvözlünk, {{ $user->keresztnev }}!</h1>
            <p style="font-size: 16px; color: #e2e8f0;">Köszönjük, hogy csatlakoztál hozzánk!</p>
        </div>

        <!-- Tartalom -->
        <div style="padding: 24px;">
            <div style="margin-bottom: 24px;">
                <p style="font-size: 16px; color: #4a5568; margin-bottom: 16px;">Az alábbi adatokkal regisztráltál:</p>
            ...
            <div style="text-align: center;">
                <a href="{{ route('bejelentkezes') }}" class="btn-gradient" style="background: linear-gradient(135deg, #6b46c1, #4299e1); color: white; padding: 12px 24px; border-radius: 9999px; text-decoration: none; display: inline-block; font-weight: bold;">
                    Bejelentkezés
                </a>
            </div>
        </div>
        ...
        <div style="background-color: #f7fafc; padding: 16px; text-align: center;">
            <p style="font-size: 12px; color: #718096;">Ha nem te regisztráltál, kérlek, hagyd figyelmen kívül ezt az e-mailt.</p>
        </div>
    </div>
</body>
</html>
